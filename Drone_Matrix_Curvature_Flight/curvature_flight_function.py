...
def send_body_frame_velocity_once(velocity_x, velocity_y, velocity_z, duration):
    """
    Move vehicle in direction based on specified velocity vectors.
    """
    print('\n')
...
def curvature_flight_body_frame(horizontal_linear_speed, radius_of_curvature, total_turn_degree_deg, velocity_z, atom_segment):
    print('\n')
